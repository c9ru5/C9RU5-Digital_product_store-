        ...
        <div class="container-fluid">
            <div class="card mb-4">
                <div class="card-header">
                    <h3 class="card-title">Tổng đã hủy: <?= $total ?></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <button data-id="<?= $order['id'] ?>" class="btn btn-outline-warning mx-1 btn-show"><i
                          ...
                          <button class="btn btn-outline-danger mx-1"><i
                              class="bi bi-x-circle"></i></button> -->
                                            <button data-id="<?= $order['id'] ?>" class="btn btn-outline-danger mx-1 btn-delete"><i
    ...
    $(document).ready(function() {
        ...
        $(".btn-delete").click(function() {
            ...
            if (confirm("Bạn có chắc chắn muốn xóa không?")) {
                $.ajax({
                    url: "<?= _WEB_ROOT ?>/admin/order/deleteOrder",
                    type: "POST",
                    data: {
                        id: order_id
                    },
