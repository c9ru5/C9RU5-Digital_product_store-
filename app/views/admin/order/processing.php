        ...
        <div class="container-fluid">
            <div class="card mb-4">
                <div class="card-header">
                    <h3 class="card-title">Tổng đang xử lý: <?= $total ?></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <button class="btn btn-outline-warning mx-1 btn-show" data-id="<?= $order['id'] ?>"><i
                                                    class="bi bi-box-arrow-up-right"></i></button>
                                            <button data-id="<?= $order['id'] ?>" class="btn btn-outline-success mx-1 btn-approval"><i class="bi bi-check-circle"></i></button>
                                            <button data-id="<?= $order['id'] ?>" class="btn btn-outline-danger mx-1 btn-cancel"><i
...
<script>
    $(document).ready(function() {
        ...
        $(".btn-approval").click(function() {
            ...
            if (confirm("Bạn có chắc chắn muốn duyệt đơn không?")) {
                $.ajax({
                    url: "<?= _WEB_ROOT ?>/admin/order/approvalOrder",
                    type: "POST",
                    data: {
                        id: order_id
                    },
        ...
        $(".btn-cancel").click(function() {
            ...
            if (confirm("Bạn có chắc chắn muốn hủy đơn không?")) {
                $.ajax({
                    url: "<?= _WEB_ROOT ?>/admin/order/cancelOrder",
                    type: "POST",
                    data: {
                        id: order_id
                    },
